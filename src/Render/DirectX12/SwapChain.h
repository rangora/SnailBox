...
namespace sb
{
    ...
    public:
        ...
        // D3D12_CPU_DESCRIPTOR_HANDLE* GetCPUDescriptorHandles() { return m_mainRenderTargetDescriptor; }
    ...
    private:
        ...
        // ComPtr<IDXGISwapChain> m_swapChain; // 필요 없음??
        ...
        D3D12_CPU_DESCRIPTOR_HANDLE m_mainRenderTargetDescriptor[SWAP_CHAIN_BUFFER_COUNT]; // imgui 방식(descriptorHeap꺼 사용)
